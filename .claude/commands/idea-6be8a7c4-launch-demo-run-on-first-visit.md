# Launch Demo Run on First Visit

## Metadata
- **Category**: user_benefit
- **Effort**: Medium (2/3)
- **Impact**: High (3/3)
- **Scan Type**: onboarding_optimizer
- **Generated**: 11/14/2025, 9:42:40 PM

## Description
When the Runner is opened for the first time, automatically create a lightweight demo test suite, start a run, and stream logs. The user sees a live progress bar and sample logs, learning how the UI works without any clicks. A brief banner explains that this is a demo and offers a button to create a real suite.

## Reasoning
Provides instant visual feedback, removes the need to manually select or configure a suite, and demonstrates core workflow. Users quickly see success and are more likely to continue using the feature.
