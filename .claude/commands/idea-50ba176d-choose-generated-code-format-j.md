# Choose Generated Code Format: JavaScript or TypeScript
...
## Description
Introduce a setting in the wizard that lets users pick whether the generated Playwright script should be JavaScript or TypeScript. Generate a corresponding type-safe template when TypeScript is selected, or a plain JS template otherwise. Update the code editor to provide appropriate syntax highlighting and linting based on the choice.

## Reasoning
TypeScript offers type safety and better IDE support, but some projects use plain JavaScript. Allowing the user to decide increases adoption while preserving consistency. The trade-off lies between developer experience and project compatibility.
